...
if __name__ == '__main__':
    ...
    myclf_gauss = gen_gauss(tweets)

    tweets_eval = load_tweets('eval.txt')
    ...
    gauss_results = myclf_gauss.predict(T)

    result_report('report.txt',results)
    result_report('gaussreport.txt',gauss_results)
